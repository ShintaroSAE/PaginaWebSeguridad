    ...
    <main className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-gray-800 to-blue-900">
      <section className="text-center max-w-2xl p-6">
        ...
        <div className="mt-6 flex gap-20 justify-center">
          <a
            href="/registro"
            className="px-8 py-3 rounded bg-violet-900 text-white font-semibold hover:bg-blue-700 transition"
          >
            Registrarse
          </a>
          <a
            href="/login"
            className="px-8 py-3 rounded bg-blue-700 text-white font-semibold hover:bg-blue-950 transition"
          >
            Iniciar sesión
          </a>
        </div>
